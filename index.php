...
<head>
    ...
    <title>CodeBreaker - Become The Best Decoder</title>
...
<body>
    ...
    <div class="layout-column" id="app">
        <header>
            <h1 translate="no">CodeBreaker</h1>
        </header>
    
        <div class="layout-column">

            <a href="./pages/CodeOfTheDay.php" class="btn-long">
                <span id="svg">
            ...
            <a href="./pages/solo.php" class="btn-long">
                <span>
        ...
        <div class="layout-row">
            <a href="./pages/rules.php" class="btn-short">
            ...
            <a href="https://ko-fi.com/ayico" target="_blank" class="btn-short">
                <img src="./uploads/icons/kofi_logo.png" alt="" style="height: 60px;margin-left: 2px;">
            </a>
            <a href="./pages/settings.php" class="btn-short" style="margin-left: auto;">
